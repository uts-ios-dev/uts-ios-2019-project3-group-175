...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GroceryHelper2",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14GroceryHelper211AppDelegate")
...
SWIFT_CLASS("_TtC14GroceryHelper222HaveListViewController")
@interface HaveListViewController : UIViewController <UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate>
...
/// \param sender Delete button
///
- (void)deleteRow:(UIButton * _Nonnull)sender;
...
SWIFT_CLASS("_TtC14GroceryHelper222NeedListViewController")
@interface NeedListViewController : UIViewController <UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate>
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified tableView;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified itemTextField;
- (void)viewDidLoad;
/// Removes keyboard when return is clicked
...
SWIFT_CLASS("_TtC14GroceryHelper222SettingsViewController")
@interface SettingsViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified pwdTextFieldOne;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified pwdTextFieldTwo;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified currentPwd;
/// Change a users password
/// \param sender any
///
- (IBAction)changePassword:(id _Nonnull)sender;
/// Log out user
- (IBAction)logOutWithSender:(id _Nonnull)sender;
/// Deletes account
...
SWIFT_CLASS("_TtC14GroceryHelper214ViewController")
