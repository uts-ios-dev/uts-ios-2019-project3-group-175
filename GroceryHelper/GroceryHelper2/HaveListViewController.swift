...
class HaveListViewController: UIViewController, UITableViewDataSource, UITextFieldDelegate, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        refItems = Database.database().reference().child("itemsHave")
    ...
    /// Loads users have items from database and adds items to tableview
    func loadData() {
    ...
    @objc func deleteRow(_ sender: UIButton) {
        ...
        let msg = UIAlertController(title: "", message: "Do you want to add item to Need list?", preferredStyle: .alert)
        let yes = UIAlertAction(title: "Yes", style: .default, handler: { (action) -> Void in
            let refHave = Database.database().reference().child("itemsNeed")
    ...
    @IBAction func addItem(_ sender: Any) {
        ...
        addItem(itemName: itemTextField.text!)
    }
